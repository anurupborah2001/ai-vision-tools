    ...
    def setup(self, config: dict):
        if self.backend == "easyocr":
            try:
                ...
                raise ImportError("Install with: pip install easyocr") from e
            ...
            try:
                ...
                raise ImportError("Install with: pip install paddleocr") from e
        elif self.backend == "opencv_east":
            if not self.model_path:
                print(
                    "[TextDetector] Warning: model_path not provided for opencv_east. Skipping detection."
                )
