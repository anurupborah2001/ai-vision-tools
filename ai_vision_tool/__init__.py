...
_EXPORTS = {
    ...
    "AIVisionPipeline": (
        "ai_vision_tool.pipelines.vision_pipeline",
        "AIVisionPipeline",
    ),
    # preprocessing
    "AdaptiveThreshold": (
        "ai_vision_tool.preprocessing.intensity",
        "AdaptiveThreshold",
    ),
    "AspectRatioFilter": ("ai_vision_tool.preprocessing.quality", "AspectRatioFilter"),
    "AutoAdjustContrast": (
        "ai_vision_tool.preprocessing.auto_adjust_contrast",
        "AutoAdjustContrast",
    ),
    ...
    "BoundingBoxNormalize": (
        "ai_vision_tool.preprocessing.geometry",
        "BoundingBoxNormalize",
    ),
    ...
    "DuplicateImageCheck": (
        "ai_vision_tool.preprocessing.quality",
        "DuplicateImageCheck",
    ),
    ...
    "RemoveBackground": (
        "ai_vision_tool.preprocessing.classical_segmentation",
        "RemoveBackground",
    ),
    ...
    # augmentation
    "AffineTransform": (
        "ai_vision_tool.augmentation.geometric_random",
        "AffineTransform",
    ),
    ...
    "CompressionArtifacts": (
        "ai_vision_tool.augmentation.blur_artifact",
        "CompressionArtifacts",
    ),
    ...
    "MultiplicativeNoise": (
        "ai_vision_tool.augmentation.noise_dropout",
        "MultiplicativeNoise",
    ),
    ...
    "RandomBrightnessContrast": (
        "ai_vision_tool.augmentation.weather_light",
        "RandomBrightnessContrast",
    ),
    ...
    "SuperResolution": (
        "ai_vision_tool.enhancement.models.super_resolution",
        "SuperResolution",
    ),
    # capture
    "BurstPictureTaker": (
        "ai_vision_tool.capture.burst_image_capture",
        "BurstPictureTaker",
    ),
    ...
    "TimeLapseCapture": (
        "ai_vision_tool.capture.time_lapse_capture",
        "TimeLapseCapture",
    ),
    ...
    "AutoLabeller": (
        "ai_vision_tool.integrations.labeling.auto_labeller",
        "AutoLabeller",
    ),
    "DarknetAutoLabeler": (
        "ai_vision_tool.integrations.labeling.darknet_auto_labeler",
        "DarknetAutoLabeler",
    ),
    "TensorFlowAutoLabeler": (
        "ai_vision_tool.integrations.labeling.tensorflow_auto_labeler",
        "TensorFlowAutoLabeler",
    ),
    # models
    ...
    "KeypointDetector": (
        "ai_vision_tool.detection.keypoint_detector",
        "KeypointDetector",
    ),
    ...
    # segmentation
    "InstanceSegmenter": (
        "ai_vision_tool.segmentation.instance_segmenter",
        "InstanceSegmenter",
    ),
    "MaskPostProcessor": (
        "ai_vision_tool.segmentation.mask_post_processor",
        "MaskPostProcessor",
    ),
    "PanopticSegmenter": (
        "ai_vision_tool.segmentation.panoptic_segmenter",
        "PanopticSegmenter",
    ),
    "SAMSegmenter": ("ai_vision_tool.segmentation.sam_segmenter", "SAMSegmenter"),
    "SemanticSegmenter": (
        "ai_vision_tool.segmentation.semantic_segmenter",
        "SemanticSegmenter",
    ),
    # pipelines
    ...
    "ParallelPipeline": (
        "ai_vision_tool.pipelines.parallel_pipeline",
        "ParallelPipeline",
    ),
    ...
    "SlidingWindowBuffer": (
        "ai_vision_tool.streaming.buffered_stream",
        "SlidingWindowBuffer",
    ),
    ...
    "WebSocketSink": (
        "ai_vision_tool.integrations.streaming.websocket_sink",
        "WebSocketSink",
    ),
    "WebSocketSource": (
        "ai_vision_tool.integrations.streaming.websocket_sink",
    ...
    "FrameAnnotator": (
        "ai_vision_tool.visualization.frame_annotator",
        "FrameAnnotator",
    ),
    "FrameViewer": ("ai_vision_tool.visualization.frame_viewer", "FrameViewer"),
    "HeatmapRenderer": (
        "ai_vision_tool.visualization.heatmap_renderer",
        "HeatmapRenderer",
    ),
    "VideoAnnotationExporter": (
        "ai_vision_tool.visualization.video_annotation_exporter",
        "VideoAnnotationExporter",
    ),
    # utils
    ...
    "MetricsLoggerComponent": (
        "ai_vision_tool.utils.metrics_logger",
        "MetricsLoggerComponent",
    ),
