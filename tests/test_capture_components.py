...
from visionflow.components.burst_picture_taker import BurstPictureTaker
from visionflow.components.frame_grabber import FrameGrabber
from visionflow.components.image_exporter import ImageExporter
from visionflow.components.picture_taker import PictureTaker
from visionflow.components.roi_capture import ROICapture
from visionflow.components.video_taker import VideoTaker
...
def test_burst_picture_taker_stops_when_capture_fails(monkeypatch, sample_frame):
    ...
    monkeypatch.setattr("visionflow.components.burst_picture_taker.time.sleep", lambda seconds: None)
